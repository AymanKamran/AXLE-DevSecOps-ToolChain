...
docker run -v "${PWD}":/Users/dapicoop/Desktop/SideProjects/AXLE-DevSecOps-ToolChain/AXLE-DevSecOps-ToolChain/GearOne-Chisel/InheritanceVerification_BuildingContainerWithOwaspGlue.sh --rm owasp/glue –t OWASPDependencyCheck -d /src
